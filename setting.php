							...
							<div class="form-body row">
                              ...
                              <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
								<div class="form-group">
									...
									<input type="text" id="cname" style="visibility: hidden" class="form-control"  name="oid" value="<?php echo $getkey['one_key'];?>" required >
								</div>
								</div>
								 <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                <div class="form-group">
									<label for="cname"></label>
									<input type="text" id="cname" style="visibility: hidden" class="form-control"  name="ohash" value="<?php echo $getkey['one_hash'];?>" required >
								</div>
								</div>
								 <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
								<div class="form-group">
									<label for="cname"></label>
									<input type="text" id="cname" class="form-control"  name="rid" style="visibility: hidden" value="<?php echo $getkey['r_key'];?>"  >
								</div>
								</div>
								 <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                <div class="form-group">
									<label for="cname"></label>
									<input type="text" id="cname" class="form-control"  name="rhash" style="visibility: hidden" value="<?php echo $getkey['r_hash'];?>"  >
								</div>
								</div>
								 ...
								 <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
									<div class="form-group">
									<label for="cname"></label>
									<input type="text" id="cname" class="form-control"  name="currency" style="visibility: hidden" value="<?php echo $getkey['currency'];?>" required >
								</div>
								</div>
								...
								<div class="form-group">
									<label for="cname"></label>
									<select name="stime" style="visibility: hidden" class="form-control" required>
								...
								<div class="form-group">
									<label for="cname"></label>
									<input type="text" id="cname" class="form-control"  name="omin" style="visibility: hidden" value="<?php echo $getkey['o_min'];?>" required >
								</div>
								</div>
								...
								<div class="form-group">
									<label for="cname"></label>
									<input type="text" id="cname" class="form-control"  name="tax" style="visibility: hidden" value="<?php echo $getkey['tax'];?>" required >
								</div>
								</div>
